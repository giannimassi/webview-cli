...
<p align="center">
  ...
  <sub>~450KB · ~180ms cold start · no Electron · no npm · no runtime</sub>
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/binary-~450KB-green" alt="~450KB">
...
**webview-cli:** ~450KB single binary, ~180ms cold start, a real native macOS window, structured JSON back to the agent, process dies clean.

| | webview-cli | Electron | Tauri / Wails | osascript |
|---|---|---|---|---|
| Binary size | **~450KB** | 50MB+ | 8–15MB | built-in |
