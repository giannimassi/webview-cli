...
// MARK: - Embedded Markdown Parser (micromark)

// micromark@4.0.2 bundled via esbuild IIFE, 2026-04-17
// Verified self-contained: 0 external CDN imports, runs standalone in WKWebView
// Bundle size: 53.3 KB minified (IIFE format)
let micromarkJS = #"""
